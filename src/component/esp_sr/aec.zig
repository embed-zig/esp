...
pub const Config = struct {
    ...
    /// Number of adaptive filter taps. Larger values improve cancellation
    /// at the cost of higher CPU load. Recommended: 4 (ESP32-S3/P4), 2 (ESP32-C5).
    filter_length: i32 = 4,
    channel_num: i32 = 1,
    mode: Mode = .sr_high_perf,
};

extern fn espz_sr_aec_create(sample_rate: i32, filter_length: i32, channel_num: i32, mode: i32) ?*anyopaque;
