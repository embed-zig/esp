...
{
    /* Upstream API is spelled "mase_destory" (sic). */
...
void *espz_sr_aec_create(int sample_rate, int filter_length, int channel_num, int mode)
{
    return aec_create(sample_rate, filter_length, channel_num, (aec_mode_t)mode);
}
