...
#if __has_include("led_strip_rmt.h")
#include "led_strip_rmt.h"
#define ESPZ_LED_STRIP_RMT_SUPPORTED 1
#endif

#if __has_include("led_strip_spi.h")
#include "led_strip_spi.h"
#define ESPZ_LED_STRIP_SPI_SUPPORTED 1
#endif
...
int32_t espz_led_strip_new_rmt(
    ...
    void **out_handle)
{
#ifdef ESPZ_LED_STRIP_RMT_SUPPORTED
...
int32_t espz_led_strip_new_spi(
    ...
    void **out_handle)
{
#ifdef ESPZ_LED_STRIP_SPI_SUPPORTED
    if (out_handle == NULL || max_leds == 0) {
        return ESP_ERR_INVALID_ARG;
    }
